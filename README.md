    ...
    <tbody>
      <tr>
        <td align="center" style="padding: 15px; border: 1px solid #1f242c; line-height: 1.6;">
          <font size="5" color="#ffffff"><b>15,000+</b></font><br />
          <font size="3" color="#8b949e">Production Servers Managed</font><br />
          <font size="2" color="#58a6ff"><i>High-Volume, Low-Latency Runtimes</i></font>
        </td>
        <td align="center" style="padding: 15px; border: 1px solid #1f242c; line-height: 1.6;">
      ...
      <tr>
        <td align="center" style="padding: 15px; border: 1px solid #1f242c; line-height: 1.6;">
          <font size="5" color="#ffffff"><b>-30%</b></font><br />
          <font size="3" color="#8b949e">Mean Time To Resolve (MTTR)</font><br />
          <font size="2" color="#00f5ff"><i>Self-Healing Qdrant RAG Pipeline</i></font>
        </td>
        <td align="center" style="padding: 15px; border: 1px solid #1f242c; line-height: 1.6;">
